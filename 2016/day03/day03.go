...
//		When I first started this year I had considered going
// back and rewriting the inputs as "for line" in file, rather
// than dumping the file into text and splitting it. But here
// it made it easier to do it that way since we needed to
// look ahead lines.
...
func main() {
	...
	input, err := ioutil.ReadFile("./2016_03.txt")
	check(err)
